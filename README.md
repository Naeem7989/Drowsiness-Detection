...
For a more detailed explanation of this project, check [*Drowsiness_Detection.pdf*](https://github.com/Naeem7989/Drowsiness-Detection-System/blob/main/Drowsiness_Detection.pdf).
...
2.  driver's posture and position of the automobile driver's face. 
...
Result: As shown above, when there is an ambient amount of light, the automobile driver's face and eyes are successfully detected.  


Test case 2: Position of the automobile driver's face  
...
Result: As shown above, when the automobile driver's face is positioned at the Centre, the face, eyes, eye blinks, and drowsiness were successfully detected.  
...
Result: As shown above, when the automobile driver's face is positioned at the Right, the face, eyes, eye blinks, and drowsiness were successfully detected. 
...
Result: As shown in the screen snapshot above, when the automobile driver's face is positioned at the Left, the face, eyes, eye blinks, and drowsiness were successfully detected.  
...
Result: As shown in the  screen  snapshot   above, when  the  automobile  driver  is  wearing spectacles, the face, eyes, eye blinks, and drowsiness were successfully detected. 


Test case 4: When the automobile driver’s head is tilted    

<p align="center">
<img width="600" height="350" src="Images/6.png ">
</p>
                                          
Result: As shown in the screen snapshot above, when the automobile driver's face is tilted more than 30 degrees from the vertical plane, it was observed that face and eye detection failed.  

The system was extensively tested even in real-world scenarios, which was achieved by placing the camera on the visor of the car, focusing on the automobile driver. It was found that the system gave positive output unless there was any direct light falling on the camera.       

## Future Scope

Smartphone application: It can be implemented as a smartphone application, which can be installed on smartphones. The automobile driver can start the application after placing it in a position where the camera is focused on the driver.
...
* Twitter: [@naeemmeer12](https://twitter.com/naeemmeer12)
* Github: [@Naeem7989](https://github.com/Naeem7989)
* LinkedIn: [@Naeem Hassan](https://www.linkedin.com/in/naeem-hassan-software-engineer/)
